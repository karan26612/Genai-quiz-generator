...
> **Note:** A Gemini API key is only needed if you're **running or deploying** this app yourself. Visitors who just use an already-deployed instance of EcoSpark don't need a key of their own — it's configured once by whoever hosts the app.

- Python 3.9 or later
- A [Google Gemini API key](https://aistudio.google.com/app/apikey) (for the person setting up/deploying the app)
